# 3rdSemester_Generative_Models_VAE  Генерация картинок c помощью VAE

Домашнее задание №1 (vo_HW)
Это домашнее задание состоит из двух частей:

I часть.Реализовать безусловную генерацию картинок с помощью VAE тренированную на датасете MNIST и оценить качество по метрике FID.
